...
## Ιστορίες Χρηστών
Στην παρούσα ενότητα θα παρουσιαστεί ένα σύνολο σεναρίων που συνδέονται με ένα συγκεκριμένο σκοπό του χρήστη.Αξίζει να σημειωθεί ότι δεν αναλύονται όλες οι λειτουργίες του συστήματος παρά μόνο οι σημαντικότερες.
Ορισμένα από τα σενάρια χρήσης θα αναπαρασταθούν σε μορφή διαγράμματος *Use Case*. Τα διαγράμματα περιπτώσεων χρήσεων (*Use Case Diagrams*) περιγράφουν τις λειτουργικές απαιτήσεις του συστήματος.Μία περίπτωση χρήσης (*Use Case*) μπορεί να είναι ένα σύνολο σεναρίων με τον ίδιο στόχο είτε και ένα σύνολο σεναρίων που αποσκοπούν στην εκπλήρωση ενός στόχου ενός χρήστη.Οι χρήστες ονομάζονται ερμηνευτές ή δρώντες (*actors*), και επισημαίνεται ότι δεν είναι απαραίτητα άνθρωποι. Μία περίπτωση χρήσης μπορεί να περιλαμβάνει μια άλλη (*includes*), ή και να επεκτείνει μια άλλη (*extends*)
Παρακάτω παρουσίαζεται το διάγραμμα χρήσης του Bizard. 
