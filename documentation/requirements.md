...
Τα επιλεγμένα προϊόντα του χρήστη - πελάτη πρέπει να περιέχονται σε ένα καλάθι αγορών.

* **Περιγραφή:** Το καλάθι των αγορών είναι απαραίτητο για την ομαλή έκβαση της αγοράς. Περιλαμβάνει την λίστα με τα έργα τέχνης που έχουν επιλέξει οι χρήστες - πελάτες, καθώς και μία λεπτομερή ανάλυση του συνολικού κόστους. 
...
Το σύστημα πρέπει να δείχνει τη διαθεσιμότητα των προϊόντων.
