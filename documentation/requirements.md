...
* **Περιγραφή:** <p align="justify">Είναι η διαδικασία κατά την οποία ο χρήστης αναγνωρίζεται από το σύστημα σε κάθε επόμενη επίσκεψη του (μετά από την εγγραφή του) και αποτελεί έναν αποτελεσματικό και ασφαλή τρόπο για να ξεπερασθεί το πρόβλημα του προσδιορισμού του ίδιου του χρήστη που εισέρχεται στην ιστοσελίδα του e-shop από διαφορετικά IPs ή να διακρίνει διαφορετικούς χρήστες που χρησιμοποιούν την ίδια IP. Η αναγνώριση γίνεται με την εισαγωγή του ονόματος του χρήστη (*User Name*) και τοu κωδικού πρόσβασης (*Password*).</p>
