...
Οι πιστοποιημένοι χρήστες πρέπει να μπορούν να εισέρχονται στο σύστημα (*Log In*) και να εξέρχονται (*Log Out*).
...
Οι χρήστες πρέπει να μπορούν να κάνουν αναζήτηση έργων τέχνης χρησιμοποιόντας λέξεις κλειδιά.
