...
* **User Priority: (5/5)** Η διαδικασία εξόδου είναι ουσιώδης για το χρήστη καθώς οποιαδήποτε στιγμή μπορεί να αποσυνδεθεί από το e-shop και συνεχίσει την περιήγηση του ως ανώνυμος πελάτης.
...
* **Περιγραφή:** Είναι πολύ σημαντικό για την ομαλή λειτουργία της υπηρεσίας να δίνεται η δυνατότητα αξιολόγησης στους πελάτες. Η αξιολόγηση θα υποβάλλεται αμέσως μετά την παραλαβή των έργων τέχνης και αποτελεί ένα μέτρο απόδοσης. Ακόμη και σε περιπτώσεις που η αξιολόγηση δεν είναι η επιθυμητή (αρνητικά σχόλια) ο διαχειριστής επικοινωνεί άμεσα με τον πελάτη και διορθώνει το πρόβλημα.
...
* **Περιγραφή:** Ο χρήστης έχει τη δυνατότητα να αναζητήσει το έργο τέχνης που επιθυμεί εισάγοντας λέξεις κλειδιά όπως το όνομα του δημιουργού, τον τύπο της κατασκευής, την κατηγορία του έργου τέχνης κτλ.
...
* **Τechnical difficulty:(5/5)** Αποτελεί αναπόσπαστο κομμάτι της αρχιτεκτονικής του συστήματός μας. Σε κάθε σελίδα του e-shop θα προβάλλεται η επιλογή της αναζήτησης. 
...
Οι χρήστες να μπορούν να βλέπουν μία μεγέθυνση της φωτογραφίας ενός προϊόντος.

* **Περιγραφή:** Δίνει στον χρήστη την επιλογή της μεγέθυνσης ενός έργου τέχνης, ώστε να μπορέσει να διακρίνει καλύτερα τα χαρακτηριστικά του.

* **User Priority (4/5):** Αρκετά σημαντική λειτουργία για τον χρήστη-πελάτη. Μέσω της συγκεκριμένης απαίτησης δίνεται στον χρήστη μία αναλυτική προεπισκόπηση του έργου που θέλει να αγοράσει. Προβάλλονται καλύτερα τα χαρακτηριστικά και οι λεπτομέρειες του πίνακα.

* **Technical Priority (4/5):** Σε κάθε έργο θα πρέπει να υπάρχει η δυνατότητα μεγέθυνσης. Η ηλεκτρονική πώληση έργων τέχνης απαιτεί την ύπαρξη αυτής της λειτουργικής απαίτησης, διότι η προώθηση και κατ' επέκταση η πώληση έργων τέχνης στηρίζεται στην λεπτομέρεια.
...
* **Περιγραφή:** Οι χρήστες του e-shop έχουν την δυνατότητα να υποβάλουν τις ερωτήσεις του άμεσα μέσω ειδικής φόρμας.
...
* **User story**: https://github.com/elefthcn/soft-eng-assignment1/blob/master/requirements/10.Contact(3).feature

### ΛΑ-11

Οι χρήστες πρέπει να έχουν τη δυνατότητα να επεξεργάζονται τα στοιχεία από το καλάθι αγορών τους.
...
* **User story**: https://github.com/elefthcn/soft-eng-assignment1/blob/master/requirements/11.EditCart(4).feature

### ΛΑ-12

Οι πελάτες θα έπρεπε να παρακολουθούν την πορεία της παραγγελίας τους.
...
* **User story**: https://github.com/elefthcn/soft-eng-assignment1/blob/master/requirements/12.CheckOrder(2).feature
...
* **User story**: https://github.com/elefthcn/soft-eng-assignment1/blob/master/requirements/13.AdminSeeOrders(1).feature
...
* **User story**: https://github.com/elefthcn/soft-eng-assignment1/blob/master/requirements/14.SalesmanQuantity(2).feature
...
* **Stability (3/5) :** Πολύ σημαντικό για την επιτυχή λειτουργία της ιστοσελίδας, ωστόσο μελλοντικά είναι δυνατή η απευθείας εισαγωγή προϊόντων από άλλες διαδικτυακές πλατφόρμες (eBay).

* **User story**: https://github.com/elefthcn/soft-eng-assignment1/blob/master/requirements/15.AddItem(2).feature
...
* **User story**: https://github.com/elefthcn/soft-eng-assignment1/blob/master/requirements/16.ImproveArt(2).feature
...
* **User story**: https://github.com/elefthcn/soft-eng-assignment1/blob/master/requirements/17.DeleteUsers(1).feature
...
* **User story**: https://github.com/elefthcn/soft-eng-assignment1/blob/master/requirements/18.EditPersonalDetails(4).feature
...
* **User story**: https://github.com/elefthcn/soft-eng-assignment1/blob/master/requirements/19.Checkout(1).feature
...
* **User story**: https://github.com/elefthcn/soft-eng-assignment1/blob/master/requirements/20.Payment(3).feature
...
<p align="justify">
Είναι ο κεντρικός διαχειριστής του συστήματος, έχοντας όλες τις λειτουργίες του συστήματος και τον πλήρη έλεγχο του συστήματος. Έχει τη δυνατότητα να προσθέτει και διαγράφει διαχειριστές, πωλητές και πελάτες. </p>

####  Διαχειριστές:
<p align="justify">
Ο διαχειριστής είναι εκείνος που διαχειρίζεται τόσο τις κατηγορίες των προϊόντων (έργα τέχνης), όσο και τους προμηθευτές. Είναι υπεύθυνος για τη σωστή λειτουργία του e-shop. Ενδεικτικές αρμοδιότητες:</p>

* Έγκριση ή απόρριψη εισαγωγής ενός έργου
* Έλεγχος της ορθότητας των στοιχείων στην περιγραφή ενός έργου
* Έλεγχος της αξιοπιστίας ενός έργου
...
πελάτες. Επίσης έχουν την δυνατότητα να διαχειρίζονται τα έργα τους στα πλαίσια της περιγραφής και της τιμολόγησης.</p>
...
που τους ενδιαφέρουν, αφού πρώτα έχουν εισάγει έγκυρα στοιχεία εισόδου στο σύστημα.</p>
...
αγορών και να ενημερώνονται για το συνολικό κόστος και τις λεπτομέρειες των προϊόντων που επέλεξαν.  </p>

## Εξωτερικά συστήματα:

Τα εξωτερικά συστήματα του e-shop συμπεριλαμβάνουν:

* Το σύστημα έγκρισης πιστωτικών καρτών που περιλαμβάνει τη σύνδεση με εξωτερικές βάσεις δεδομένων πιστωτικών ιδρυμάτων.
* Το σύστημα έγκρισης Paypal που περιλαμβάνει τη σύνδεση με τη βάση δεδομένων του Paypal.
* Σύστημα ελέγχου ταυτότητας που είναι η βάση δεδομένων με τα στοιχεία των εγγεγραμμένων χρηστών.
* Η βάση δεδομένων που περιλαμβάνει τα στοιχεία του προϊόντων.

## Ιστορίες Χρηστών
<p align="justify">
Στην παρούσα ενότητα θα παρουσιαστεί ένα σύνολο σεναρίων που συνδέονται με ένα συγκεκριμένο σκοπό του χρήστη. Ουσιαστικά περιγράφονται αναλυτικότερα οι απαιτήσεις του χρήστη από το σύστημα, αναδεικνύοντας τις απαιτούμενες υπηρεσίες που πρέπει να παρέχει το σύστημα και γενικότερα ο τρόπος αλληλεπίδρασης του χρήστη με το σύστημα. Οι ενέργειες και οι απαιτήσεις περιγράφονται με σενάρια, που περιλαμβάνουν τις ενέργειες του χρήστη και τις καταστάσεις και ανταποκρίσεις του συστήματος. </p>

Σημειώνεται ότι δεν αναλύονται όλες οι λειτουργίες του συστήματος παρά μόνο οι σημαντικότερες.
<p align="justify">
Ορισμένα από τα σενάρια χρήσης θα αναπαρασταθούν σε μορφή διαγράμματος *Use Case*. Τα διαγράμματα περιπτώσεων χρήσεων (*Use Case Diagrams*) περιγράφουν τις λειτουργικές απαιτήσεις του συστήματος. </p>
<p align="justify">
Μία περίπτωση χρήσης (*Use Case*) μπορεί να είναι ένα σύνολο σεναρίων με τον ίδιο στόχο ή/και ένα σύνολο σεναρίων που αποσκοπούν στην εκπλήρωση ενός στόχου του χρήστη. Οι χρήστες ονομάζονται χειριστές (*actors*) και επισημαίνεται ότι δεν είναι απαραίτητα άνθρωποι. Επιπλέον κάθε εξωτερικό σύστηµα που αλληλεπιδρά µε το υπό ανάπτυξη σύστηµα αναπαρίσταται µε ένα χειριστή. Μία περίπτωση χρήσης μπορεί να περιλαμβάνει μια άλλη (*includes*) ή/και να επεκτείνει μια άλλη (*extends*).</p>

Παρακάτω παρουσιάζεται το διάγραμμα χρήσης του e-shop. 
...
![Screenshot](UML-Diagrams/UseCaseDiagram.png)
...
διαγράµµατα δραστηριοτήτων περιγράφουν µια ακολουθία δραστηριοτήτων, όπου µπορούµε να έχουµε παράλληλες δραστηριότητες, συνθήκες κ.λπ. </p>
<p align="justify">
...
Στη µελέτη περίπτωσης του e-shop και στην παρούσα φάση ανάπτυξης τα διαγράµµατα δραστηριοτήτων θα µπορούσαν να χρησιµοποιηθούν για την καλύτερη κατανόηση των περιπτώσεων χρήσης.</p>
...
#### Mockups:
 <p align="justify">
Σε αυτήν την ενότητα παρουσιάζονται τα Mockups τα οποία παρέχουν όλη την πληροφορία για το πώς θα μοιάζει το *Urban Picasso* E-shop. Μέσα από τη δημιουργία του mockup δίνονται σημαντικές πληροφορίες, όπως είναι η χρωματική παλέτα, οι γραμματοσειρές και η γενικότερη αισθητική. Παρακάτω παρατίθονται τα mockups με τα αντίστοιχα link.</p>
...
λειτουργίες που παρέχονται από το σύστημα. Στις πιο πολλές περιπτώσεις οι µη λειτουργικές απαιτήσεις είναι βασικές αφού η µη ικανοποίηση 
αυτών αχρηστεύει το σύστηµα. Πιο συγκεκριμένα αποτελούν τους περιορισμούς στις υπηρεσίες ή τις λειτουργίες που προσφέρει το σύστημα, όπως χρονικοί περιορισμοί, περιορισμοί στη διαδικασία ανάπτυξης, αποδοτικότητα, πρότυπα, την απόδοση, την νομιμότητα και την ιδιωτικότητα κτλ. Οι μη λειτουργικές απαιτήσεις πρέπει να είναι μετρήσιμες. </p>

Παρακάτω παρουσιάζονται ορισμένες από τις μη λειτουργικές απαιτήσεις του e-shop.
 
### ΜΛΑ-1

Το σύστημα πρέπει να κρυπτογραφεί τα προσωπικά στοιχεία των πελατών. 

* **Περιγραφή:** Τα προσωπικά στοιχεία των χρηστών πρέπει να µεταφέρονται κρυπτογραφηµένα από τον internet browser στον web server έτσι ώστε να αποφύγουµε τον κίνδυνο υποκλοπής δεδοµένων. Με άλλα λόγια τέτοιου είδους στοιχεία δεν πρέπει να αποθηκεύονται σε μορφή καθαρού κειμένου. Μια συνήθης μορφή κρυπτογράφησης αποτελούν τα κλειδιά κρυπτογράφησης.
...
* **Stability: (3/5)** Η συγκεκριμένη απαίτηση μεταβάλλεται ανάλογα με τις τεχνολογίες ασφαλείας που αναπτύσσονται γύρω από την κρυπτογράφηση δεδομένων.
...
* **User Priority: (5/5)**  Είναι απαραίτητο για το χρήστη, καθώς αν ο χρόνος απόκρισης υπερβεί τα 2 δευτερόλεπτα το σύστημα καθίσταται αργό και αναξιόπιστο και ο υποψήφιος πελάτης τερματίζει γρήγορα τη διαδικασία, πριν καν περιηγηθεί στην ιστοσελίδα του e-shop. Για τους πωλητές αυτό συνεπάγεται σε χαμηλές πωλήσεις.   

* **Technical Priority: (5/5)** Η απαίτηση αποτελεί βασικό χαρακτηριστικό της αρχιτεκτονικής του συστήματος, στην οποία η ομάδα ανάπτυξης προσδίδει ιδιαίτερη προσοχή.

* **Stability: (3/5)** Η συγκεκριμένη απαίτηση είναι ευμετάβλητη, καθώς οι απαιτήσεις σε ταχύτητα και αποδοτικότητα αυξάνονται συνεχώς, συνεπώς μελλοντικά μπορεί να θεωρηθεί αναποτελεσματική και να τροποποιηθεί.
...
* **Technical Priority: (5/5)** Η ομάδα ανάπτυξης θα πρέπει να λάβει υπόψην τον χρόνο υλοποίησης της λειτουργίας, καθώς γρήγορες συναλλαγές συμβάλουν στην αύξηση των πωλήσεων.
...
* **User Priority: (3/5)** Η δυνατότητα αυτόματου χρονικού ορίου είναι πολύτιμη, επειδή βοηθά στην προστασία του λογαριασμού ενός χρήστη από μη εξουσιοδοτημένη πρόσβαση. Παρόλο που συγκαταλέγεται σε ένα από τα χαρακτηριστικά ασφάλειας του λογαριασμού χρήστη δεν είναι και το μοναδικό.

* **Technical Priority: (4/5)** Τόσο για τους χρήστες όσο και για την ομάδα ανάπτυξης είναι απαραίτητη διασφάλιση των αρχείων του χρήστη και του συστήματος και συμβάλει στην διασφάλιση αυτών.
...
* **User Priority: (4/5)** Αρκετά σημαντικό για τον χρήστη, καθώς δεν περιορίζει τον τρόπο με τον οποίο θα καταθέσει τα χρήματα του προκειμένου να αγοράσει ένα πίνακα. 
