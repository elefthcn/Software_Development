...
* Πρώτο διάγραμμα Δραστηριοτήτων: Απεικονίζεται η διαδικασία δημιουργίας λογαριασμού χρήστη.
![Screenshot](UML-Diagrams/uml_Activity_1.png)


* Δεύτερο διάγραμμα Δραστηριοτήτων: Παρουσιάζονται τα επιµέρους βήµατα που εκτελούνται για την αγορά ενός πίνακα από πελάτες. Στο συγκεκριμένο διάγραμμα έχει προηγηθεί η διαδικασία εισόδου από τον χρήστη-πελάτη.
